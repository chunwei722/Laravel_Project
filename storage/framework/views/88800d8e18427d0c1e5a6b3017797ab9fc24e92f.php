...
<header class="jumbotron" id="header">
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="/articles"><img src="<?php echo e(asset('img/logo.gif')); ?>" width="70px" height="50px"></a>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
       ...
       <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
        <div class="card mb-4">
          <img class="card-img-top" src="<?php echo e($article->image); ?>" width = 500px height =700px alt="Card image cap">
          <div class="card-body">
            <h2 class="card-title"><?php echo e($article->title); ?></h2>
            <p class="card-text"><?php echo e($article->short); ?></p>
            <a href="/article/<?php echo e($article->id); ?>" class="btn btn-primary">看更多內容 &rarr;</a>
          </div>
          <div class="card-footer text-muted">
            更新於<?php echo e($article->updated_at); ?>
